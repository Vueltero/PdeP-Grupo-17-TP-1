...
--patenteTiene7Digitos = (cantidadDigitos 7 . patente)
...
lima :: Auto -> Auto
lima auto = auto { desgasteLlantas = (ponerLlanta.ponerLlanta.quitarLlanta.quitarLlanta.desgasteLlantas) auto }
...
desgastePar :: ListaAutos -> Bool                       -- compara si los componenetes pares tienen un desgaste par
desgastePar lista = all (even.cantidadDesgaste.desgasteLlantas) (listaIndicePar lista)

desgasteImpar :: ListaAutos -> Bool                     -- compara si los componenetes impares tienen un desgaste impar
